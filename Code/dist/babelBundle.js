...
(function () {
  ...
  __webpack_require__.d(Timers_namespaceObject, {
    ...
    "TimerOffsetType": function TimerOffsetType() {
      return _TimerOffsetType;
    }
      ...
      */
      ...
      value: function fromObject(_object) {
        ...
        if (_objectJQuery.attr("type") !== "hidden" && _objectJQuery.attr("display") !== "hidden") {
          ...
          _objectBounds.top -= _Positioning.translateCssSizes(dom, "marginTop", _computedStyle);
          ...
          _position.x -= _Positioning.translateCssSizes(dom, "marginLeft", _computedStyle);
      ...
      */
      ...
      value: function returnObjectsWithinArea(areaBounds, objects) {
        ...
        objectsArray.forEach(function (dom) {
          var otherBounds = _Bounds.fromObject(dom, document);
  ...
  function _slicedToArray(arr, i) {
    return _arrayWithHoles(arr) || _iterableToArrayLimit(arr, i) || MultiKeyReversibleMap_unsupportedIterableToArray(arr, i) || _nonIterableRest();
  }
  ...
  function MultiKeyReversibleMap_createForOfIteratorHelper(o, allowArrayLike) {
    var it = typeof Symbol !== "undefined" && o[Symbol.iterator] || o["@@iterator"];

    if (!it) {
      if (Array.isArray(o) || (it = MultiKeyReversibleMap_unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === "number") {
        if (it) o = it;
        var i = 0;
  ...
  function MultiKeyReversibleMap_unsupportedIterableToArray(o, minLen) {
    if (!o) return;
    if (typeof o === "string") return MultiKeyReversibleMap_arrayLikeToArray(o, minLen);
    var n = Object.prototype.toString.call(o).slice(8, -1);
    if (n === "Object" && o.constructor) n = o.constructor.name;
    if (n === "Map" || n === "Set") return Array.from(o);
    if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return MultiKeyReversibleMap_arrayLikeToArray(o, minLen);
  }

  function MultiKeyReversibleMap_arrayLikeToArray(arr, len) {
    if (len == null || len > arr.length) len = arr.length;
  ...
  var _PubSub = /*#__PURE__*/function () {
    function PubSub() {
      ...
      PubSub_defineProperty(this, "_subscribers", new _MultiKeyReversibleMap(_Event.toString(), "function"));
    }
  ...
  var _TimerManager = /*#__PURE__*/function () {
    ...
    */
    function TimerManager() {
      ...
      TimerManager_defineProperty(this, "_timers", new _MultiKeyReversibleMap("string | number", _Timer2.toString()));
  ...
  })(_TimerOffsetType || (_TimerOffsetType = {}));
  ...
  var _Timer2 = /*#__PURE__*/function () {
    ...
    function Timer(name, timingInterval) {
      ...
      var offsetType = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : _TimerOffsetType.NoOffset;
      ...
      Timer_defineProperty(this, "_offsetType", _TimerOffsetType.NoOffset);
      ...
      if (!(offsetType in _TimerOffsetType)) {
      ...
      this.startTime = _TimerManager.Time();
    ...
    Timer_createClass(Timer, [{
      ...
      function start() {
        ...
        this.running = true;
        this.lastTickTime = _TimerManager.Time();
        this.loop();
      }
      /**
       * Stop this Timer
      ...
      value: function loop() {
        ...
        if (this.offsetType != _TimerOffsetType.NoOffset && this.currentTimingInterval == this.timingInterval) {
          ...
          var delay = targetTime - _TimerManager.Time();

          if (this.offsetType == _TimerOffsetType.OffsetIncludeSkipOffset) {
  ...
  var _RealtimeTimer = /*#__PURE__*/function (_Timer) {
    ...
    */
    ...
    function RealtimeTimer(name) {
      ...
      _this = _super.call(this, name, 10, [], startOnCreation, timerRunTime, _TimerOffsetType.OffsetIgnoreSkipOffset);
  ...
  function ScaledTimer_createForOfIteratorHelper(o, allowArrayLike) {
    var it = typeof Symbol !== "undefined" && o[Symbol.iterator] || o["@@iterator"];

    if (!it) {
      if (Array.isArray(o) || (it = ScaledTimer_unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === "number") {
        if (it) o = it;
        var i = 0;
  ...
  function ScaledTimer_unsupportedIterableToArray(o, minLen) {
    if (!o) return;
    if (typeof o === "string") return ScaledTimer_arrayLikeToArray(o, minLen);
    var n = Object.prototype.toString.call(o).slice(8, -1);
    if (n === "Object" && o.constructor) n = o.constructor.name;
    if (n === "Map" || n === "Set") return Array.from(o);
    if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return ScaledTimer_arrayLikeToArray(o, minLen);
  }

  function ScaledTimer_arrayLikeToArray(arr, len) {
    if (len == null || len > arr.length) len = arr.length;
  ...
  var _ScaledTimer = /*#__PURE__*/function (_Timer) {
    ...
    */
    ...
    function ScaledTimer(name, timeScalers) {
      ...
      ScaledTimer_defineProperty(ScaledTimer_assertThisInitialized(_this), "_scaledEvents", new _PubSub());
  ...
  function ReversibleMap_slicedToArray(arr, i) {
    return ReversibleMap_arrayWithHoles(arr) || ReversibleMap_iterableToArrayLimit(arr, i) || ReversibleMap_unsupportedIterableToArray(arr, i) || ReversibleMap_nonIterableRest();
  }

  function ReversibleMap_nonIterableRest() {
    throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");
  }

  function ReversibleMap_iterableToArrayLimit(arr, i) {
    var _i = arr == null ? null : typeof Symbol !== "undefined" && arr[Symbol.iterator] || arr["@@iterator"];
  ...
  function ReversibleMap_arrayWithHoles(arr) {
    if (Array.isArray(arr)) return arr;
  }

  function ReversibleMap_createForOfIteratorHelper(o, allowArrayLike) {
    var it = typeof Symbol !== "undefined" && o[Symbol.iterator] || o["@@iterator"];

    if (!it) {
      if (Array.isArray(o) || (it = ReversibleMap_unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === "number") {
        if (it) o = it;
        var i = 0;
  ...
  function ReversibleMap_unsupportedIterableToArray(o, minLen) {
    if (!o) return;
    if (typeof o === "string") return ReversibleMap_arrayLikeToArray(o, minLen);
    var n = Object.prototype.toString.call(o).slice(8, -1);
    if (n === "Object" && o.constructor) n = o.constructor.name;
    if (n === "Map" || n === "Set") return Array.from(o);
    if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return ReversibleMap_arrayLikeToArray(o, minLen);
  }

  function ReversibleMap_arrayLikeToArray(arr, len) {
    if (len == null || len > arr.length) len = arr.length;
